from .get_page_process import GetPageProcess
from .get_page_threading import GetPageThreading
from .get_combine import GetCombine
...
class News ():
    ...
    def get_combine(self,
        ...
        combine = GetCombine(folder_path=self.folder_path,
                             ...
                             day_ago=day_ago,)
        combine.run()
        print(f"combine {day_ago} day finish")
